...
- Home は現状 upcoming games view であり、followed-team summary view ではない
  - upcoming games がない followed team はユーザーから見えにくくなる可能性がある
  - 「followed teams / My Teams」summary section または screen は game display logic とは別タスクとして検討する
...
- followed teams / My Teams summary UI の検討
...
### Task 2: followed teams / My Teams summary UI を検討
- Home は現状 upcoming games view であり、followed-team summary view ではない
- followed teams without upcoming games が見えにくい問題は game display logic と分けて扱う
- 「followed teams / My Teams」summary section または screen を検討する

### Task 3: `Team` / `Game` model gaps を整理
