...
| pending | 水戸ホーリーホック | Mito Hollyhock | `mito_hollyhock` | 要確認 | 要確認 | 水戸, ホーリーホック, Mito Hollyhock | J.LEAGUE official 2026 J1 list | unresolved; API-SPORTS /teams search lookup not completed | Membership confirmed; API ID/logo unresolved |
...
| pending | ジェフユナイテッド千葉 | JEF United Chiba | `jef_united_chiba` | 要確認 | 要確認 | 千葉, ジェフ, ジェフ千葉, JEF United Chiba, JEF Chiba | J.LEAGUE official 2026 J1 list | unresolved; API-SPORTS /teams search lookup not completed | Membership confirmed; API ID/logo unresolved |
...
| pending | 清水エスパルス | Shimizu S-Pulse | `shimizu_s_pulse` | 要確認 | 要確認 | 清水, エスパルス, Shimizu S-Pulse | J.LEAGUE official 2026 J1 list | unresolved; API-SPORTS /teams search lookup not completed | Membership confirmed; API ID/logo unresolved |
...
| pending | ファジアーノ岡山 | Fagiano Okayama | `fagiano_okayama` | 要確認 | 要確認 | 岡山, ファジアーノ, Fagiano Okayama | J.LEAGUE official 2026 J1 list | unresolved; API-SPORTS /teams search lookup not completed | Membership confirmed; API ID/logo unresolved |
...
| pending | Ｖ・ファーレン長崎 | V-Varen Nagasaki | `v_varen_nagasaki` | 要確認 | 要確認 | 長崎, Ｖ・ファーレン, V-Varen Nagasaki, V. Varen Nagasaki | J.LEAGUE official 2026 J1 list | unresolved; API-SPORTS /teams search lookup not completed | Membership confirmed; API ID/logo unresolved |
