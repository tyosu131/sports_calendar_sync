...
| pending | 水戸ホーリーホック | Mito Hollyhock | `mito_hollyhock` | 305 | `https://media.api-sports.io/football/teams/305.png` | 水戸, ホーリーホック, Mito Hollyhock | J.LEAGUE official 2026 J1 list | API-SPORTS /teams search lookup; ID/logo match | Membership confirmed; API ID/logo matched by lookup |
...
| pending | ジェフユナイテッド千葉 | JEF United Chiba | `jef_united_chiba` | 301 | `https://media.api-sports.io/football/teams/301.png` | 千葉, ジェフ, ジェフ千葉, JEF United Chiba, JEF Chiba | J.LEAGUE official 2026 J1 list | API-SPORTS /teams search lookup; ID/logo match | Membership confirmed; API ID/logo matched by lookup |
...
| pending | 清水エスパルス | Shimizu S-Pulse | `shimizu_s_pulse` | 283 | `https://media.api-sports.io/football/teams/283.png` | 清水, エスパルス, Shimizu S-Pulse | J.LEAGUE official 2026 J1 list | API-SPORTS /teams search lookup; ID/logo match | Membership confirmed; API ID/logo matched by lookup |
...
| pending | ファジアーノ岡山 | Fagiano Okayama | `fagiano_okayama` | 310 | `https://media.api-sports.io/football/teams/310.png` | 岡山, ファジアーノ, Fagiano Okayama | J.LEAGUE official 2026 J1 list | API-SPORTS /teams search lookup; ID/logo match | Membership confirmed; API ID/logo matched by lookup |
...
| pending | Ｖ・ファーレン長崎 | V-Varen Nagasaki | `v_varen_nagasaki` | 285 | `https://media.api-sports.io/football/teams/285.png` | 長崎, Ｖ・ファーレン, V-Varen Nagasaki, V. Varen Nagasaki | J.LEAGUE official 2026 J1 list | API-SPORTS /teams search lookup; ID/logo match | Membership confirmed; API ID/logo matched by lookup |

## Pending Current J1 Teams

The Review Table above now includes the official/current J1 membership candidates. Rows remain `pending` until they are explicitly approved for `j1Teams.js`, even when API-SPORTS team ID and logo URL are resolved. Do not add pending rows to `j1Teams.js`.
