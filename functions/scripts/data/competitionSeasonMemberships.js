...
const FOOTBALL_J2_J3_2026_HYAKUNEN_TEAM_ID_STATUSES = {
  ...
  iwaki_fc: 'confirmed_team_master',
  rb_omiya_ardija: 'confirmed_team_master',
  hokkaido_consadole_sapporo: 'confirmed_team_master',
  ...
  ac_nagano_parceiro: 'confirmed_team_master',
  ...
  zweigen_kanazawa: 'confirmed_team_master',
  fc_osaka: 'confirmed_team_master',
  fc_imabari: 'confirmed_team_master',
  nara_club: 'confirmed_team_master',
  kamatamare_sanuki: 'confirmed_team_master',
  tegevajaro_miyazaki: 'confirmed_team_master',
  sagan_tosu: 'confirmed_team_master',
