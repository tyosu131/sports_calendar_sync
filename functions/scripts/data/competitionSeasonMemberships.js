...
const FOOTBALL_J2_J3_2026_HYAKUNEN_TEAM_ID_STATUSES = {
  ...
  tokushima_vortis: 'candidate_not_confirmed',
  albirex_niigata: 'candidate_not_confirmed',
  kochi_united: 'candidate_not_confirmed',
  ehime_fc: 'candidate_not_confirmed',
  zweigen_kanazawa: 'candidate_not_confirmed',
  fc_osaka: 'candidate_not_confirmed',
  fc_imabari: 'candidate_not_confirmed',
  nara_club: 'candidate_not_confirmed',
