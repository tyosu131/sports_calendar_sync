...
const j1Teams = [
  ...
  },
  {
    ...
    aliases: ['町田', 'ゼルビア', 'FC町田', 'FC町田ゼルビア', 'FC Machida Zelvia', 'Machida Zelvia'],
    externalTeamId: 303,
  ...
  },
  {
    ...
    aliases: ['横浜FM', '横浜F・マリノス', 'マリノス', 'Yokohama F･Marinos', 'Yokohama F. Marinos', 'F. Marinos'],
    externalTeamId: 296,
  ...
  },
  {
    ...
    aliases: ['長崎', 'Ｖ・ファーレン', 'V・ファーレン長崎', 'V-Varen Nagasaki', 'V. Varen Nagasaki'],
    externalTeamId: 285,
