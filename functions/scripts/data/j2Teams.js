...
const j2Teams = [
  ...
  },
  {
    ...
    nameJa: '横浜ＦＣ',
    nameEn: 'Yokohama FC',
    aliases: ['横浜FC', '横浜ＦＣ', '横浜', 'Yokohama FC'],
    externalTeamId: 307,
  ...
  },
  {
    ...
    aliases: ['大宮', '大宮アルディージャ', 'RB大宮', 'RB大宮アルディージャ', 'ＲＢ大宮', 'RB Omiya Ardija', 'Omiya Ardija'],
    externalTeamId: 313,
  ...
  },
  {
    ...
    aliases: ['鹿児島', '鹿児島ユナイテッド', '鹿児島ユナイテッドFC', 'Kagoshima United'],
    externalTeamId: 2236,
  ...
  },
  {
    ...
    aliases: ['山口', 'レノファ山口', 'レノファ山口FC', 'Renofa Yamaguchi'],
    externalTeamId: 309,
