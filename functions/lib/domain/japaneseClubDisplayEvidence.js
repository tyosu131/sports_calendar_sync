...
exports.normalizeClubDisplayKey = normalizeClubDisplayKey;
exports.japaneseClubDisplayName = japaneseClubDisplayName;
...
function normalizeClubDisplayKey(value) {
    return value.normalize("NFKC").toLocaleLowerCase("en").replace(/[^a-z0-9]/g, "");
}
const JAPANESE_BY_NORMALIZED_ALIAS = new Map(CLUBS.flatMap((club) => club.aliases.map((alias) => [normalizeClubDisplayKey(alias), club.japanese])));
function japaneseClubDisplayName(value) {
    return JAPANESE_BY_NORMALIZED_ALIAS.get(normalizeClubDisplayKey(value));
}
//# sourceMappingURL=japaneseClubDisplayEvidence.js.map