...
void main() {
  ...
  test('canonical identity overrides a provider display variant', () {
    final value = game(
      competition: 'football_premier',
      homeJa: 'アーセナルFC',
      awayJa: 'Brighton & Hove Albion',
      homeEn: 'Arsenal FC',
      awayEn: 'Brighton & Hove Albion',
      homeProvider: 'Arsenal FC',
      homeTeamId: 'arsenal',
    );
    expect(teamDisplayNames.homeName(value), 'Arsenal');
    expect(teamDisplayNames.awayName(value), 'Brighton & Hove Albion');
  });
