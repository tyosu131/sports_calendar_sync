...
final upcomingGamesForTeamProvider =
...
final gamesStreamForTeamProvider =
...
final upcomingGamesForFollowedTeamsProvider =
    FutureProvider<List<Game>>((ref) async {
  final teamIds = ref.watch(followedTeamIdsProvider);
  if (teamIds.isEmpty) return [];
  return ref
      .watch(gameRepositoryProvider)
      .fetchUpcomingGamesForTeams(teamIds);
});
